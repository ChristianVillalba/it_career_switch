// btnGetSunriseSunsetInfo - getSunriseSunsetInfo.php
$('#btnGetSunriseSunsetInfo').click(function() {
    ...
    $.ajax({
		...
		error: function(jqXHR, textStatus, errorThrown) {
            ...
            console.error('Error retrieving data from Sunrise/Sunset API:', textStatus, errorThrown); // Log the error
		}
    });
});
